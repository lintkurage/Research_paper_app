...
```bash
git clone https://github.com/lintkurage/Research_paper_app.git
cd Research_paper_app
```
...
arXiv・ACM・Springer などの論文ページからワンクリックで Coerulin に追加できます。
...
> Coerulin サーバー（`python3 app.py`）が起動している状態で使用してください。
